...
const Expertise = () => {
  return (
    <section id="expertise" className="py-16 md:py-24">
      <div className="section-shell rounded-[2.25rem] bg-base-100/55 px-5 py-8 md:px-8 md:py-10">
            ...
            {expertise.map((item) => (
              <article key={item} className="surface-panel rounded-[2rem] p-5">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm font-medium leading-7 text-base-content/85">{item}</p>
                </div>
              </article>
            ))}
          </div>
