...
const MobileDock = ({ theme, onToggleTheme }: MobileDockProps) => {
  return (
    <div className="fixed bottom-4 left-1/2 z-50 flex w-[calc(100%-1.5rem)] max-w-lg -translate-x-1/2 items-center gap-2 lg:hidden">
      <nav
        className="flex-1 rounded-full border border-white/60 bg-slate-950/92 px-2 py-2 text-white shadow-2xl shadow-slate-950/20 backdrop-blur"
